    ...
    <>
      ...
      <section className="py-16 sm:py-24 px-4 text-center">
        ...
        <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
          Paste any song lyrics and let AI rewrite them to match your voice, range, and style. Perfect for worship leaders, cover artists, and performers.
        </p>
      ...
      <section className="py-12 sm:py-16 px-4 text-center bg-panel">
        <h2 className="text-2xl font-bold mb-3">Ready to start rewriting?</h2>
