    ...
    <>
      ...
      <section className="py-16 sm:py-24 px-4 max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed">
          <p>
            [PLACEHOLDER] porchsongs is an AI-powered tool that helps musicians, worship leaders, and
            performers rewrite song lyrics to match their unique voice, range, and style.
          </p>
          <p>
            [PLACEHOLDER] Whether you need to transpose chords, simplify complex arrangements, or
          ...
          <p>
            [PLACEHOLDER] Built by musicians, for musicians. We believe every performer should be
