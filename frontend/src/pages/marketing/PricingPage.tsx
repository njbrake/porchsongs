...
const PLANS = [
  {
    ...
    period: '/mo',
    features: [
      '10 rewrites per month (parse + chat)',
      '1 profile',
      '25 saved songs',
      'PDF export',
    ],
  ...
  },
  {
    ...
    period: '/mo',
    features: [
      '200 rewrites per month (parse + chat)',
      'Unlimited profiles & saved songs',
      'Longer songs & responses',
      'Everything in Free',
    ],
    cta: 'Upgrade to Pro',
    ...
    <>
      ...
      <section className="py-16 sm:py-24 px-4 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-12">
          Start for free. Upgrade when you need more rewrites.
        </p>
        ...
        <p className="text-sm text-muted-foreground max-w-xl mx-auto mt-8">
          Each rewrite counts as one use — this includes the initial parse and each follow-up chat refinement.
        </p>
      </section>
    </>
  );
