...
export const HOWTO_ARTICLES: HowToArticleData[] = [
  {
    ...
    title: '[PLACEHOLDER] Getting Started with porchsongs',
    excerpt: '[PLACEHOLDER] Learn how to paste lyrics, run your first rewrite, and save songs to your library.',
    content: `[PLACEHOLDER] Getting Started with porchsongs
...
Save the rewrite to your library. You can organize songs into folders and export them as PDF performance sheets.`,
  },
  {
    ...
    title: '[PLACEHOLDER] Using Chat to Refine Rewrites',
    excerpt: '[PLACEHOLDER] Master the iterative chat feature to get exactly the rewrite you want.',
    content: `[PLACEHOLDER] Using Chat to Refine Rewrites
...
- "Replace the bridge with something more upbeat"`,
  ...
  {
    slug: 'pdf-export',
    title: '[PLACEHOLDER] Exporting PDF Performance Sheets',
    excerpt: '[PLACEHOLDER] Generate clean, printable chord sheets for live performance.',
    content: `[PLACEHOLDER] Exporting PDF Performance Sheets
